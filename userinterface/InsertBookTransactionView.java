...
public class InsertBookTransactionView extends View
{
        ...
        submitButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent e) {
                ...
                if (!failToInsert) {
                    ...
                    processBookInsertion(bookTitle, bookAuthor, bookPubYear);

                    displayMessage("The books have been added!");
    ...
    public void processAction(Event evt)
    {
        ...
        if ((bookTitleEntered == null) || (bookTitleEntered.isEmpty())) {
            displayErrorMessage("Please enter a valid book title!");
            bookTitleTextbox.requestFocus();
            failToInsert = true;
        } else if ((bookAuthorEntered == null) || (bookAuthorEntered.isEmpty())) {
            displayErrorMessage("Please enter a valid book author!");
            bookAuthorTextbox.requestFocus();
            failToInsert = true;
        } else if ((bookPublicationYearEntered == null) || (bookPublicationYearEntered.isEmpty())) {
            displayErrorMessage("Please enter a valid publication year!");
     ...
     */
    //----------------------------------------------------------
    private void processBookInsertion(String bookTitle, String bookAuthor, String bookPubYear) {
