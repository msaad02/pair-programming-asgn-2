 ...
 */
//==============================================================
public class BookSystem extends Application {

    // start method for this class, the main application object
    //----------------------------------------------------------
    public void start(Stage primaryStage) {
        System.out.println("Library Version 1.0");
        System.out.println("Copyright 2004/2015 Sandeep Mitra and T M Rao");

        // Create the top-level container (main frame) and add contents to it.
        MainStageContainer.setStage(primaryStage, "Brockport Library System v1.0");
        /**
        ...
        try {
            ...
            System.err.println("ATM.ATM - could not create Library!");
            new Event(Event.getLeafLevelClassName(this), "ATM.<init>", "Unable to create Library object", Event.ERROR);
            exc.printStackTrace();
        }
